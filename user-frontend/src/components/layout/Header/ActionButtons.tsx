...
import { FiSearch, FiHeart, FiShoppingCart, FiUser, FiMenu, FiLogOut, FiChevronDown ,FiGrid} from "react-icons/fi";
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-48 bg-surface/95 backdrop-blur-xl border border-white/10 rounded-xl p-1.5 shadow-2xl z-50 animate-[scaleUp_0.15s_ease-out]">
                <Link
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-text hover:bg-primary/10 hover:text-primary rounded-lg transition-colors"
                >
